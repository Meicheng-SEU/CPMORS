...
(
  ...
  INNER JOIN sofa
    ...
    AND sofa.endtime >= DATETIME_SUB(soi.suspected_infection_time, INTERVAL '24' HOUR)
    AND sofa.endtime <= DATETIME_ADD(soi.suspected_infection_time, INTERVAL '12' HOUR)
