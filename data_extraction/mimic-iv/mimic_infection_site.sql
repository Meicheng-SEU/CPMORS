...
right join `cpmors.mimic.sepsis3` sepsis3 on isd.stay_id=sepsis3.stay_id
-- where isd.hospstay_seq=1
),
infectionsite as
(
...
case when icd_version=9 and (substr(icd_code,1,3) in ("038") or substr (icd_code,1,5) in ("78552","99592")) then 1
     when icd_version=10 and (substr(icd_code,1,4) in ("A409","A412","A411","A403","A414","A413",
     "A419") or substr(icd_code,1,5) in ("A4101","A4102","A4150","A4151","A4152","A4153","A4159","A4189","R6521","R6520")) then 1
...
case when icd_version=9 and (substr(icd_code,1,3) in ("567") or substr(icd_code,1,5) in 
("00845","56983","56721","56722","56723","56789") or substr(icd_code,1,4) in ("5670","5671","5679","6145","1220","1228","5720")) then 1
     when icd_version=10 and (substr(icd_code,1,3) in ("K67") or substr(icd_code,1,4) in 
("K658","K650","K651","K652","K650","K689","K653","K654","K658","K631","k750","D733","K630","K750","K610","K612","K611","N151") or substr(icd_code,1,5) 
in ("A0471","A0472","K6812","K6819","T8643","K3533","K3532")or substr(icd_code,1,6) 
in ("K50814","K50014","L02211")) then 1
     else 0 end as Peritoneal_infection,
case when icd_version=9 and (substr(icd_code,1,3) in ("010","011","012","481","482","485","486","521","310","796","382","412","502","391") or substr(icd_code,1,4) in 
("0310","5070","4957","1123","1124","5130","1190","1194","1195","1370","4801","4871","1363","4800","4802",
"4808","4809","4820","4821","4822","4829","4830","4838","4841","4846","4847","4848","4870","5078") or substr(icd_code,1,5) in ("51633","51634","46611","48882","48230","48231","48239","48240","48241","48242","48249",
"48281","48282","48283","48284","48289","48801","48811","48881","99731","99732")) then 1
     when icd_version=10 and (substr(icd_code,1,3) in ("B02","B59","J13","J14","J42","J40","J22") or substr(icd_code,1,4) in ("A150","A159","A157","A156","A155","A154","A158","A199","A310","A311","A312","A318","A319","A403","A420","A430","B250","B953","B961","B371","B440","B441","B450","J120","J121","J122",
     "J129","J181","J150","J151","J154","J153","J158","J155","J156","A481","J180","J189","J157","J158","J101","J111",
     "J159","J168","J180","J188","J189","J851","J852","J690","J698","J680","J440","J441","J208","J209","J410","J219","J208","J209","J470","R845") 
     or substr(icd_code,1,5) in ("A0222","J09X1","J1000","J1001","J1008","J1100","J1108"
     ,"J1289","J1520","J1529","J0410","J1289") or substr(icd_code,1,6) in ("J15211","J15212","J95811","J84116","J84113"))then 1
...
case when icd_version=9 and (substr(icd_code,1,3) in ("013","036","094","320","322","325") or 
substr(icd_code,1,4) in ("3240","3241","3249","3201"))then 1
     when icd_version=10 and (substr(icd_code,1,3) in ("G08","G01") or 
substr(icd_code,1,4) in ("A170","A171","A179","A390","A523","G000","G001","G002","G003",
"G008","G009","G042","G030","G038","G031","G039","G060","G061","G062") or 
substr(icd_code,1,5) in ("A1781","A1782","A1789","A3981","A5211","A5213","A5214","A5219"))then 1
else 0 end as cns_infection,
case when icd_version=9 and (substr(icd_code,1,3) in ("016","098","590","597","601","614","615","616","980") or
substr(icd_code,1,4) in ("5990","5909","5839","5809","5800","5804","5810","5811","5831","5832","5834","5902","5970","6012") or substr(icd_code,1,5) in ("58389","58289","58089",
"58381","58389","59010","59011","59080","64661","64662","64663","64664")) then 1
     when icd_version=10 and (substr (icd_code,1,3) in ("N51","N10","N12") or substr(icd_code,1,4) in ("N110","N151","N340","N341","N342","N343","N390","N410","N411","N412","N413","N414","N418","N419","N730","N731","N732","N733","N736","N734","N738","N739","N710",
     "N711","N719","N72","N760","N761","N762","N763","N771","N750","N751","N764","N766","N770","N759","N765") or
substr(icd_code,1,5) in ("A1811","A1810","A1812","A1813","A1815","A1814","A1817","A1816","A1818","A5400","A5429","A5401",
"A5422","A5423","A5403","A5424","A5421","A5442","N7001","N7002”,”N7003”,”N7011”,”N7012",
"N7013”,”N7091”,”N7092”,”N7093”,”N7681","N7689","O8620")) then 1 else 0 end as Genitourinary_infection,
...
case when icd_version=9 and (substr (icd_code,1,2) in ("38","88","30","85","90") or substr (icd_code,1,3) in ("003","014","540","541","542","566","329","845","843",
"862","863","869")or substr (icd_code,1,5) in ("56201","56203","56211","56213","56782") 
or substr (icd_code,1,4) in ("5720","5721", "5750","5550","5551","5552","5695","5559","5581","5582","5400","5401","5409")) then 1
     when icd_version=10 and (substr (icd_code,1,3) in ("K37","K36") or substr (icd_code,1,4) in ("A020","A028","A029","K352","K353","A049",
     "K610","K611","K613","K630","K750","K751", "K810","k048","A045","A046","K520","K654","K521")or substr (icd_code,1,5) in ("A0220","A0229","A1831","A1832","A1839","K3580",
     "K5712", "K5713","K5732","K5733","K3533","K3532","K3580")or substr (icd_code,1,6) in ("K50814","K50813","K50014","K50012","A0839")) then 1 else 0 end as Gastrointestinal_infection,
case when icd_version=9 and icd_code in ("461","462","463","464","465") then 1
     ...
     "J0510”,”J0511”,”J0430”,”J0431”,”J060”,”J069”,”Other infection”,”A000”,”A001”,”A009”,”A0100”,”A011",
