...
The MIMIC-IV data used in this present study can be retrieved from [https://physionet.org/content/mimiciv/2.2/](https://physionet.org/content/mimiciv/2.2/). eICU-RI data: [http://eicu-crd.mit.edu/](https://physionet.org/content/eicu-crd/2.0/)
